						   ...
						   D3DXMATRIX baseViewMatrix)
{
	...
	result = UpdateSentence(m_sentence1, "Hello", 20, 20, 1.0f, 1.0f, 0.0f, deviceContext);
	if(!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "how are you?", 20, 40, 0.0f, 1.0f, 0.0f, deviceContext);
	if(!result)
	{
		return false;
	}
	...
	//// Now update the sentence vertex buffer with the new string information.
	//result = UpdateSentence(m_sentence3, "What's going on?", 200, 200, 0.0f, 0.5f, 1.0f, deviceContext);
	//if(!result)
	//{
	//	return false;
	//}
