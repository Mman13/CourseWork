...
const char str_left_eye_pixel_shader[]  =
"#define NUM_LIGHTS 4\n"
"\n"
"cbuffer LightBuffer\n"
"{\n"
...
LeftEye3DShader::LeftEye3DShader(ID3D11Device* device, const class abfw::Default3DShaderData& shader_data) :
abfw::Default3DShaderD3D11(device, (const char *)default_3d_shader_vs_hlsl, default_3d_shader_vs_hlsl_len, str_left_eye_pixel_shader, sizeof(str_left_eye_pixel_shader), "", "", shader_data)
{
}