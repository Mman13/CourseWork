...
void ShooterScreen::LoadContent()
{
...
void ShooterScreen::UnloadContent()
{
...
void ShooterScreen::UpdateEvent(sf::Event event, sf::RenderWindow &Window)
{
	if(victory == false)
	{
		if(paused == false)
...
void ShooterScreen::Update(sf::RenderWindow &Window, sf::Clock clock)
{
...
void ShooterScreen::Draw(sf::RenderWindow &Window, sf::Clock clock)
{
